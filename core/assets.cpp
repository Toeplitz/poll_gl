...
void Stock_Shaders::init(Scene &scene)
{
 ...
 void Stock_Nodes::init(Scene &scene)
{
  ...
  {
    node_symbol_cone = &scene.load(POLL_DATA_PATH, "cone.dae", MODEL_IMPORT_OPTIMIZED | MODEL_IMPORT_NO_DRAW | MODEL_IMPORT_NO_UPLOAD);
  ...
  {
    node_symbol_disk = &scene.load(POLL_DATA_PATH, "disk.dae", MODEL_IMPORT_OPTIMIZED | MODEL_IMPORT_NO_DRAW | MODEL_IMPORT_NO_UPLOAD);
  ...
  {
    node_light_sphere = &scene.load(POLL_DATA_PATH, "sphere.obj", MODEL_IMPORT_OPTIMIZED | MODEL_IMPORT_NO_DRAW | MODEL_IMPORT_NO_UPLOAD);
...
void Assets::init(Scene &scene)
{
  stock_nodes.init(scene);
  stock_shaders.init(scene);
}
